...
public static class Data
{
    ...
    //Stores the values for maximum enemies allowed on screen for each level
    public static int onScreenBronze = 3;
    public static int onScreenSilver = 5;
    public static int onScreenGold = 10;
    public static int EnemiesOnScreenNow = 0;   //Counts number of enemies on the screen currently
